...
const banners = [
  {
    id: 1,
    title: "UNITECH Audio Range",
    subtitle: "Premium Sound Solutions",
    description: "Tower Speakers • Home Theatres • Portable Sound",
    discount: "Price on Request",
    cta: "Explore Audio",
  ...
  },
  {
    ...
    subtitle: "Crystal-Clear Entertainment",
    description: "Reliable DTH solutions for your home",
  ...
  {
    id: 3,
    title: "Hot Selling Essentials",
    subtitle: "Most Popular Products",
    description: "Adapters • SMPS Supply • USB/SD Modules",
    discount: "In Stock",
    cta: "View Hot Products",
